...
export const Button = ({
  ...
  const classes = [
    ...
    theme === "special" &&
      "border-violet-700 text-violet-700 shadow-violet-500/25 hover:bg-violet-700 hover:text-slate-50 focus:ring-violet-700/75 active:bg-violet-800 active:text-slate-50 dark:border-violet-300 dark:text-violet-300 dark:shadow-violet-300/25 dark:hover:bg-violet-300 dark:hover:text-slate-900 dark:focus:ring-violet-300/75 dark:active:bg-violet-400 dark:active:text-slate-900",
    ...
    theme === "special-inverse" &&
      "border-violet-300 text-violet-300 shadow-violet-300/25 hover:bg-violet-300 hover:text-slate-900 focus:ring-violet-300/75 active:bg-violet-400 active:text-slate-900 dark:border-violet-700 dark:text-violet-700 dark:shadow-violet-500/25 dark:hover:bg-violet-700 dark:hover:text-slate-50 dark:focus:ring-violet-700/75 dark:active:bg-violet-800 dark:active:text-slate-50",
  ];
